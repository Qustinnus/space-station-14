...
{
    public abstract class SharedStrippingComponent : Component
    {
        ...
        public sealed override string Name => "Stripping";
        public sealed override uint? NetID => ContentNetIDs.STRIPPING;
